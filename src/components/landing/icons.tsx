// Inline SVG icons — viewBox 0 0 24 24, stroke-based, no fill

export function IconHazard({ className }: { className?: string }) {
  return (
...
export function IconInspection({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function Icon({ name, className }: { name: string; className?: string }) {
  const Component = iconMap[name] ?? IconDocument;
